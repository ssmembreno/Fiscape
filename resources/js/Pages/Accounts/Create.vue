...
const submit = () => form.post(route('accountsStore'));
</script>
...
<template>
  <DashboardLayout>
      ...
      <div class="flex items-center justify-between w-full">
        <nav class="text-sm text-gray-500">
          <ol class="flex items-center gap-1">
            ...
            <li>/</li>
            <li class="text-gray-700 font-medium">Nueva Cuenta</li>
          </ol>
        </nav>
        <div class="ml-auto">
          <UserMenu />
    ...
    <div class="max-w-5xl mx-auto bg-white rounded-2xl shadow-sm p-10 mt-8 border border-gray-100">
      <h2 class="text-2xl font-semibold text-gray-800 mb-8">Crear nueva cuenta</h2>
      ...
      <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <!-- Balance -->
        <div class="col-span-1">
          <label class="block text-sm font-medium text-gray-700 mb-1">Balance inicial</label>
          <input
        ...
        <div class="col-span-2">
          ...
          <textarea
            ...
            rows="4"
            placeholder="Ej: Cuenta personal para gastos del hogar, o ingresos de trabajo freelance..."
            class="w-full border rounded-lg px-3 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
          ></textarea>
