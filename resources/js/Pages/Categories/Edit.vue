...
const form = useForm({
    ...
    descripcion: props.categories.descripcion || ''
})

const submit = () => (
  form.put(route('categoriesUpdate', props.categories.id), {
    preserveScroll: true,
    onSuccess: () => {
    },
    onError: (errors) => {
...
<template>
    <Head title="Editar Categoria"></Head>
    <DashboardLayout>
        <!--Header -->
        <template #header>
            <div class="flex items-center justify-between w-full">
                ...
                <ol class="flex items-center gap-1">
                    ...
                    <li>/</li>
                    <li class="text-gray-700 font-medium">Editar Categoria</li>
                </ol>
                </nav>
                <div class="ml-auto">
                    <UserMenu />
      ...
      <h2 class="text-xl font-semibold text-gray-800 mb-6">Modificar Categoria</h2>
